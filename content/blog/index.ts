...
export const articles: ArticleMeta[] = [
  ...
  {
    slug: "california-transfer-receivers-compared",
    title:
      "CA Transfer Receivers: UC vs CSU Credit Patterns",
    description:
      "161K CA transfer mappings show every UC campus at 100% direct match — but the ASSIST system aggregate classifies all 156K CSU+UC entries as elective. Here's what that means.",
    date: "2026-06-01",
    category: "transfer-confusion",
    state: "ca",
    author: "Community College Path",
  ...
  {
    slug: "new-york-transfer-receivers-compared",
    title:
      "NY Transfer Receivers: Brockport 100% vs Empire 15%",
    description:
      "SUNY and CUNY four-year receivers range from 100% direct match (Brockport, New Paltz) to 13% (CUNY SLU) across 254K mappings. Full NY comparison.",
    date: "2026-06-01",
    category: "transfer-confusion",
    state: "ny",
    author: "Community College Path",
  ...
  {
    slug: "maine-transfer-receivers-compared",
    title: "ME Transfer Receivers: USM 12% vs UMaine 100% (2026)",
    description:
      "All 6 UMaine-system receivers accept MCCS credits with zero rejections — but direct-match rates run from 11.6% at USM to 99.8% at UMaine. Full comparison across 41,492 mappings.",
    date: "2026-06-01",
    category: "transfer-confusion",
    state: "me",
    author: "Community College Path",
  ...
  {
    slug: "california-community-college-course-availability",
    title:
      "CA Course Availability: 99.9% Scarcity (2026)",
    description:
      "99.9% of CA community college courses are scarce across 76 indexed campuses. Mt. SAC holds 346 exclusive courses — more than any other campus in the state.",
    date: "2026-06-01",
    category: "registration-timing",
    state: "ca",
    author: "Community College Path",
  ...
  {
    slug: "texas-community-college-course-availability",
    title:
      "TX Course Availability: 88.7% Scarcity (2026)",
    description:
      "88.7% of TX community college courses are scarce or point-source. ENGL-1301 runs at 33 colleges; auto body repair, game dev, and aeromechanics exist at just one.",
    date: "2026-06-01",
    category: "registration-timing",
    state: "tx",
    author: "Community College Path",
  ...
  {
    slug: "colorado-community-college-course-availability",
    title: "CO Course Availability: 44.3% Scarce, 15 Colleges (2026)",
    description:
      "15 CCCS colleges, 28,079 sections, 44.3% scarcity ratio. ENG-1021 and MAT-1340 run everywhere; welding, aviation, and film are at one campus.",
    date: "2026-06-01",
    category: "registration-timing",
    state: "co",
    author: "Community College Path",
  ...
  {
    slug: "washington-community-college-hybrid-density",
    title:
      "WA Hybrid Classes: 27.5% — Highest We've Measured (2026)",
    description:
      "SBCTC's 34 colleges run 27.5% hybrid sections — more than double Maryland's 13.7%. Centralia tops 54%, South Puget Sound 46%. Full per-college breakdown.",
    date: "2026-06-01",
    category: "course-format-density",
    state: "wa",
    author: "Community College Path",
    tags: ["hybrid", "washington", "sbctc", "ctclink", "course-format", "density", "adult-learners"],
    cluster: "hybrid-course-density-guide",
    clusterRole: "spoke",
  },
  {
    slug: "indiana-community-college-hybrid-density",
    title: "IN Hybrid Classes: Ivy Tech at 29%, 1-in-3 (2026)",
    description:
      "Ivy Tech runs 29.2% hybrid across 11,904 sections — the highest rate of any state system we track, and nearly 6x the national average. What it means for your schedule.",
    date: "2026-06-01",
    category: "course-format-density",
    state: "in",
    author: "Community College Path",
    tags: ["hybrid", "indiana", "ivy-tech", "course-format", "density", "scheduling", "adult-learners"],
    cluster: "hybrid-course-density-guide",
    clusterRole: "spoke",
  },
  {
    slug: "south-dakota-community-college-hybrid-density",
    title: "SD Hybrid Classes: OLC at 54%, STC at 0% (2026)",
    description:
      "SD's two tracked technical colleges split sharply: Oglala Lakota College runs 54.3% hybrid; Southeast Technical College runs 0%. What it means for scheduling.",
    date: "2026-06-01",
    category: "course-format-density",
    state: "sd",
    author: "Community College Path",
    tags: ["hybrid", "south-dakota", "oglala-lakota-college", "southeast-technical-college", "course-format", "density", "tribal-college"],
    cluster: "hybrid-course-density-guide",
    clusterRole: "spoke",
  },
  {
    slug: "washington-community-college-late-start-classes",
    title: "WA Late-Start Classes: 99% of Fall Starts Late (2026)",
    description:
      "WA's SBCTC is a quarter system — 99.4% of fall 2026 sections begin after Sept 14. What that means for registration timing, entry windows, and missing the main enrollment deadline.",
    date: "2026-06-01",
    category: "planning",
    state: "wa",
    author: "Community College Path",
    tags: ["late-start", "washington", "sbctc", "ctclink", "quarter-system", "registration", "adult-learners"],
    cluster: "late-start-by-state-guide",
    clusterRole: "spoke",
  },
];
