...
For a deeper dive on managing multi-campus logistics, see our [guide to building a schedule across multiple campuses](/blog/how-to-build-community-college-schedule). You can also use CC CourseMap's [Schedule Builder](/va/schedule) to pin courses from different colleges onto a single weekly calendar and spot conflicts before you register.
