...
<ProductCallout
  text="CC CourseMap lets you search courses across all colleges in a state at once — compare schedules, formats, and availability side by side."
  feature="courses"
...
For a deeper dive on managing multi-campus logistics, see our [guide to building a schedule across multiple campuses](/blog/how-to-build-community-college-schedule). You can also use CC CourseMap's [Schedule Builder](/blog/how-to-build-community-college-schedule) to pin courses from different colleges onto a single weekly calendar and spot conflicts before you register.
