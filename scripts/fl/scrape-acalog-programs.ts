/**
 * scrape-acalog-programs.ts — FL Acalog program scraper.
 *
 * Reads data/fl/catalog-discovery.json, filters colleges fingerprinted as
...
async function main() {
  ...
  console.log(`FL Acalog program scraper — ${colleges.length} college(s)\n`);
  let totalPrograms = 0;
