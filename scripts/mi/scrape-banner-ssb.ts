 ...
 *
 * Usage:
 *   npx tsx scripts/mi/scrape-banner-ssb.ts --college lansing-community-college
 *   npx tsx scripts/mi/scrape-banner-ssb.ts --all
 */
...
// MI colleges using Banner SSB 9 (3 confirmed publicly accessible)
// grand-rapids-community-college: detected as banner-ssb-9 but API redirects to login
// west-shore-community-college: detected as banner-ssb-9 but API behind CAPTCHA
