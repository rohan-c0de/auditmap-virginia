...
async function main() {
  ...
  // southeast-technical-college (acalog)
  await run("southeast-technical-college", () =>
    scrapeAcalogPrograms({ collegeSlug: "southeast-technical-college", baseUrl: "https://catalog.southeast.edu", catoidFallback: 0, programNavoids: [], autoDiscoverCatoid: true }),
  );

  // western-dakota-technical-college (courseleaf)
  await run("western-dakota-technical-college", () =>
    scrapeCourseleafPrograms({ collegeSlug: "western-dakota-technical-college", baseUrl: "https://catalog.western.edu" }),
  );
}
